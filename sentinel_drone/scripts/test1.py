...
#		self.drone_position = [self.x, self.y, self.z]
		...
		self.Kp = [26,26,45] #0.06 21,(45) ((65))
		self.Ki = [0,0,0.9] #0.001
		self.Kd = [470,470,950] #0.3 380,(830)((970))
...
if  __name__ == '__main__':
	...
	e_drone = Edrone()
	r = rospy.Rate(6.6) #specify rate in Hz based upon your desired PID sampling time, i.e. if desired sample time is 33ms specify rate as 30Hz
